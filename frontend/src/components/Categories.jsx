...
import { Box, Button, FormControl, FormLabel, Input, VStack, Heading, Text, SimpleGrid } from '@chakra-ui/react';
      ...
      <SimpleGrid columns={[1, 2, 3]} spacing={4}>
        {categories.map(category => (
          <Box key={category._id} p={4} borderWidth="1px" borderRadius="md">
            ...
            <Button onClick={() => handleEdit(category)} colorScheme="yellow" mr={2} mt={2}>Edit</Button>
            <Button onClick={() => handleDelete(category._id)} colorScheme="red" mt={2}>Delete</Button>
          </Box>
        ))}
      </SimpleGrid>
    </Box>
